...
class CameraXLivePreviewActivity :
  ...
  private val MEDIA_UPLOAD_FOLDER_NAME = "/PayMedia"
  private val IMAGE_PREFIX = "Image_"
  ...
  private fun bindAnalysisUseCase() {
    ...
    Log.e("baal er resolution", analysisUseCase!!.backpressureStrategy.toString() )
  ...
  fun getImageUriForBitmap(context: Context, inImage: Bitmap): Uri? {
    createPayMediaFolderIfNotExist(context)
  ...
  fun createPayMediaFolderIfNotExist(context: Context) {
    val directory = getPayMediaDirectory(context)
    if (!directory.exists()) {
      File(
        context.getExternalFilesDir(Environment.DIRECTORY_PICTURES),
        MEDIA_UPLOAD_FOLDER_NAME
      )
        .mkdir()
    }
  }
  ...
  fun createNewImageFile(context: Context): File {
    return File(
      getPayMediaDirectory(context), IMAGE_PREFIX +
              System.currentTimeMillis() + IMAGE_EXTENSION
    )
  }


  private fun getPayMediaDirectory(context: Context): File {
    return File(
